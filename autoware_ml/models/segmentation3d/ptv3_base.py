...
class PTv3ExportContext:
    ...
    @property
    def serialized_order(self) -> torch.Tensor:
        return self.inputs.serialized_order

    @property
    def serialized_inverse(self) -> torch.Tensor:
        return self.inputs.serialized_inverse
