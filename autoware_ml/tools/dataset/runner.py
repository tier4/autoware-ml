...
"""Dataset-generation runner used by the Autoware-ML CLI."""
...
_DATASET_GENERATORS: dict[str, type[Any]] = {
...
def generate_dataset(
    ...
    **kwargs: Any,
    ...
    """Generate dataset info files with the dataset-specific generator.

    Args:
        dataset: Dataset name, such as ``nuscenes``.
        ...
        **kwargs: Dataset-specific generator options such as version or max_sweeps.
    """
